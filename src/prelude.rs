...
//! with it. The runtime-level builtins (`print`, `input`, `size`, `has?`,
//! `split`, `number`, `text`, `insert`, `remove`) are registered directly by
//! the interpreter, not through this prelude.
